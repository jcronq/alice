...
- **Speaking Alice** (Opus, the voice that talks to Owner and Friend over Signal).
...
3. Refers to Alice in third person. Owner and Friend are the people she talks to. Be specific — use actual topic keywords you see in the digest rather than generic words like "conversation" or "tasks."
...
Alice has two hemispheres: Speaking (Opus, voices Signal to Owner and Friend) and Thinking (Sonnet, background grooming of alice-mind). They pass artifacts between each other — surfaces, notes, emergencies, thoughts.
