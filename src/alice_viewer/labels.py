...
KIND_LABELS: dict[str, str] = {
    ...
    "viewer_chat_turn_start": "viewer-chat in",
    "viewer_chat_turn_end": "viewer-chat done",
    "a2a_turn_start": "a2a in",
    "a2a_turn_end": "a2a done",
...
KIND_FAMILIES: dict[str, str] = {
    ...
    "discord_send": "turn",
    "viewer_chat_turn_start": "turn",
    "viewer_chat_turn_end": "turn",
    "a2a_turn_start": "turn",
    "a2a_turn_end": "turn",
    "turn_log": "turn",
    # artifacts
