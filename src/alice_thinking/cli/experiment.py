...
Thinking's sleep wakes drive on pi-mono (``alice_core.kernel.pi.PiKernel``),
which has no MCP support — ``_translate_tools`` in
``src/alice_core/kernel/pi.py`` strips every ``mcp__``-prefixed name
