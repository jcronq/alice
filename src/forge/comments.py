...
``trusted_authors`` (default :data:`forge.dispatcher.TRUSTED_AUTHORS`).
...
from forge.dispatcher import ART_LABEL_WHITELIST, TRUSTED_AUTHORS
...
class RouteToStudy:
    ...
    :data:`forge.dispatcher.ART_LABEL_WHITELIST`. When absent, the
...
def parse_study_complete(
    ...
    *,
    ...
    be in :data:`forge.dispatcher.ART_LABEL_WHITELIST`; the dispatcher
