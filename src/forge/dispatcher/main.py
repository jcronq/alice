...
:func:`run` orchestrates one cadence: poll for open ``sm:*`` issues, route each to its state handler, then sweep closed-stale and open-done issues. :func:`main` is the ``argparse`` wrapper invoked by ``bin/alice-sm-dispatcher`` (via ``python -m forge.dispatcher``).
"""
...
# ``forge.dispatcher.handlers``. They can't be re-exported via
...
from forge.dispatcher.handlers.building import _process_building
from forge.dispatcher.handlers.compacting import _process_compacting
from forge.dispatcher.handlers.design_review import _process_design_review
from forge.dispatcher.handlers.designed import _process_designed
from forge.dispatcher.handlers.designing import _process_designing
from forge.dispatcher.handlers.draft import _process_draft
from forge.dispatcher.handlers.needs_study import _process_needs_study
from forge.dispatcher.handlers.open_done import _process_open_done
from forge.dispatcher.handlers.reviewing import _process_reviewing
from forge.dispatcher.handlers.selected import _process_selected
from forge.dispatcher.handlers.stale_closed import _process_stale_closed
