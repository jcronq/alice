...
# implementation lives at :mod:`forge.thinking_shim`; sub-issue 3
# replaces it with the real PhaseRunner dispatch.
THINKING_SHIM_MODULE = "forge.thinking_shim"
...
# implementation lives at :mod:`forge.speaking_shim`; the real
...
SPEAKING_SHIM_MODULE = "forge.speaking_shim"
