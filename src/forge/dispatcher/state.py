...
:func:`forge.dispatcher.run`).

The schema version (:data:`STATE_VERSION`) and the FIFO cap
(:data:`SEEN_ISSUE_CAP`) live in :mod:`forge.dispatcher.constants`;
...
from forge.dispatcher.constants import SEEN_ISSUE_CAP, STATE_VERSION
