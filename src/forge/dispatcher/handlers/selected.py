...
def _process_selected(
    *,
    ...
    # A worker that realises it can't advance from forge:selected without
    ...
    try:
        ...
        if exc.looks_like_auth_failure or exc.looks_like_rate_limit:
            raise
        sel_comments = []
    from forge.comments import ReturnToStudy
    ...
    from forge.comments import parse_dependencies as _parse_deps
