...
consolidated here and each handler does::
    ...
    from forge.dispatcher.handlers._common import *
...
from forge.dispatcher.constants import (
    ACTIVE_SM_LABEL,
    ART_LABEL_WHITELIST,
    BASE_BRANCH,
    RepoConfig,
...
from forge.dispatcher.errors import GHCommandError
from forge.dispatcher.gh import (
    gh_close_issue,
    gh_edit_labels,
    gh_find_linked_pr,
...
from forge.dispatcher.git_ops import (
    _attempt_auto_rebase,
    _post_merge_cleanup,
)
from forge.dispatcher.helpers import (
...
from forge.dispatcher.rendering import (
...
from forge.dispatcher.report import (
    DependencyResolution,
    RunReport,
    resolve_dependencies,
)
from forge.dispatcher.spawn import (
    _current_spawn_map,
...
from forge.dispatcher.state import DispatcherState, load_state, save_state
from forge.dispatcher.trust import (
    TrustDecision,
    _author_login,
    _current_sm_label,
    _label_names,
...
from forge.dispatcher.types import (
    CloseIssueFn,
    EditLabelsFn,
    FindLinkedPRFn,
    FindUnspawnedFn,
...
from forge.dispatcher.verify import (
    _verify_enabled,
    default_verifier,
)
