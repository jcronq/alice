...
in-tree is :func:`alice_prompts.load` with ``meta.system_persona``;
...
# Resolve the scaffold relative to the repo root. ``src/alice_eval/``
...
def build_system_prompt(
    ...
    return alice_prompts.load("meta.system_persona", **personae)
