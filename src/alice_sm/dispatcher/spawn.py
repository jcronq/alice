...
The :data:`SPAWN_MAP` table in :mod:`alice_sm.dispatcher.constants`
...
from alice_sm.dispatcher.gh import gh_post_comment
from alice_sm.dispatcher.trust import _author_login, _current_sm_label, _label_names
