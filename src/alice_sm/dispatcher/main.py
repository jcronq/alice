...
:func:`run` orchestrates one cadence: poll for open ``sm:*`` issues, route each to its state handler, then sweep closed-stale and open-done issues. :func:`main` is the ``argparse`` wrapper invoked by ``bin/alice-sm-dispatcher`` (via ``python -m alice_sm.dispatcher``).
"""
...
# ``alice_sm.dispatcher.handlers``. They can't be re-exported via
...
from alice_sm.dispatcher.handlers.building import _process_building
from alice_sm.dispatcher.handlers.compacting import _process_compacting
from alice_sm.dispatcher.handlers.design_review import _process_design_review
from alice_sm.dispatcher.handlers.designed import _process_designed
from alice_sm.dispatcher.handlers.designing import _process_designing
from alice_sm.dispatcher.handlers.draft import _process_draft
from alice_sm.dispatcher.handlers.needs_study import _process_needs_study
from alice_sm.dispatcher.handlers.open_done import _process_open_done
from alice_sm.dispatcher.handlers.reviewing import _process_reviewing
from alice_sm.dispatcher.handlers.selected import _process_selected
from alice_sm.dispatcher.handlers.stale_closed import _process_stale_closed
