...
:func:`alice_sm.dispatcher.run`).

The schema version (:data:`STATE_VERSION`) and the FIFO cap
(:data:`SEEN_ISSUE_CAP`) live in :mod:`alice_sm.dispatcher.constants`;
...
from alice_sm.dispatcher.constants import SEEN_ISSUE_CAP, STATE_VERSION
