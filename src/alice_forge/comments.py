...
(see :mod:`alice_forge.dispatcher`).
...
``trusted_authors`` (default :data:`alice_forge.dispatcher.TRUSTED_AUTHORS`).
...
from alice_forge.dispatcher import ART_LABEL_WHITELIST, TRUSTED_AUTHORS
...
class RouteToStudy:
    ...
    :data:`alice_forge.dispatcher.ART_LABEL_WHITELIST`. When absent, the
...
def parse_study_complete(
    ...
    *,
    ...
    be in :data:`alice_forge.dispatcher.ART_LABEL_WHITELIST`; the dispatcher
