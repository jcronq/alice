...
``trusted_authors`` (default :data:`sm.dispatcher.TRUSTED_AUTHORS`).
...
from sm.dispatcher import ART_LABEL_WHITELIST, TRUSTED_AUTHORS
...
class RouteToStudy:
    ...
    :data:`sm.dispatcher.ART_LABEL_WHITELIST`. When absent, the
...
def parse_study_complete(
    ...
    *,
    ...
    be in :data:`sm.dispatcher.ART_LABEL_WHITELIST`; the dispatcher
