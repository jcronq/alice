...
# implementation lives at :mod:`sm.thinking_shim`; sub-issue 3
# replaces it with the real PhaseRunner dispatch.
THINKING_SHIM_MODULE = "sm.thinking_shim"
...
# implementation lives at :mod:`sm.speaking_shim`; the real
...
SPEAKING_SHIM_MODULE = "sm.speaking_shim"
