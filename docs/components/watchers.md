...
**TBD** — repository / event watchers. These poll external systems (GitHub, calendar, Signal-adjacent surfaces, etc.) and emit notes into `inner/notes/` for Thinking to triage. Source: `src/watchers/`.
