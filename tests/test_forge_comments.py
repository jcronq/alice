"""Tests for :mod:`forge.comments` — the ``[SM]`` comment-shape parsers.
...
:func:`forge.comments.parse_comment` dispatch wrapper.
...
from forge import comments as cm
from forge.dispatcher import ART_LABEL_WHITELIST
