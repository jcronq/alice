"""Tests for :mod:`alice_forge.comments` — the ``[SM]`` comment-shape parsers.
...
:func:`alice_forge.comments.parse_comment` dispatch wrapper.
...
from alice_forge import comments as cm
from alice_forge.dispatcher import ART_LABEL_WHITELIST
